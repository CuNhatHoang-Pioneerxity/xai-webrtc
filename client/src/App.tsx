            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", fontSize: "0.85rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Connection Quality</span>
                  <span style={{ color: connectionQuality === "excellent" ? "#28a745" : connectionQuality === "good" ? "#5cb85c" : connectionQuality === "fair" ? "#ffc107" : connectionQuality === "poor" ? "#dc3545" : "#6c757d", fontWeight: "600" }}>
                    {connectionQuality.charAt(0).toUpperCase() + connectionQuality.slice(1)}
                  </span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Connection State</span>
                  <span style={{ color: "#17a2b8" }}>{webrtcStats.connectionState}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>ICE State</span>
                  <span style={{ color: "#17a2b8" }}>{webrtcStats.iceConnectionState}</span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Audio In</span>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Audio Out</span>
                  <span style={{ color: "#28a745", fontFamily: "monospace" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Jitter</span>
                  <span style={{ color: "#fd7e14", fontFamily: "monospace" }}>
                    {webrtcStats.jitter.toFixed(2)} ms
                  </span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Packet Loss</span>
                  <span style={{ color: webrtcStats.packetLoss > 50 ? "#dc3545" : "#fd7e14", fontFamily: "monospace" }}>
                    {webrtcStats.packetLoss} pkts
                  </span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: "#6c757d" }}>Round Trip Time</span>
                  <span style={{ color: "#fd7e14", fontFamily: "monospace" }}>
                    {webrtcStats.rtt} ms
                  </span>
                </div>
