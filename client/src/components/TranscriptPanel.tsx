          ...
          transcript.map((entry, index) => (
            <div
              ...
              style={{
                marginBottom: "1rem",
                paddingBottom: "1rem",
                borderBottom: index < transcript.length - 1 ? "1px solid #e9ecef" : "none",
              }}
            >
              <div
                style={{
              ...
              >
                <span
                  style={{
                    fontWeight: "bold",
                    color: entry.role === "user" ? "#28a745" : "#17a2b8",
                  }}
                >
                  {entry.role === "user" ? "USER" : "ASSISTANT"}
                </span>
                <span style={{ color: "#adb5bd" }}>{formatTime(entry.timestamp)}</span>
              </div>
